...
<div align="center">
  <p>
    <a align="center" href="" target="https://github.com/aliasrobotics/CAI">
      <img
        width="100%"
        src="assets/032-cai-455575f2eb.png"
      >
    </a>
  </p>
...
[![version](assets/001-version-8c97aec9ac.svg)](https://badge.fury.io/py/cai-framework)
...
<div align="center">
  ...
  <a href="https://aliasrobotics.com/cybersecurityai.php" target="_blank">
    <img src="assets/033-cai-banner-3ae09415cb.svg" alt="CAI - Community and Professional Editions" width="100%" style="max-width: 900px;">
  </a>
  ...
  <table style="border-collapse: collapse; width: 100%">
    <tr>
      <td width="50%" align="center" style="padding: 0; border: none;">
        <img src="assets/028-cai-demo-afec4c04e5.gif" alt="CAI Community Edition Demo" width="100%">
      </td>
      <td width="50%" align="center" style="padding: 0; border: none;">
        <img src="assets/027-cai-pro-demo-f2d5d401c3.gif" alt="CAI PRO Professional Edition Demo" width="100%">
      </td>
    </tr>
  </table>  
</div>
...
| [![](assets/002-case-study-humanoid-portada-308150d03c.png)](https://aliasrobotics.com/case-study-humanoid-robot-g1.php) | [![](assets/003-case-study-dragosctf-bffe571cf4.png)](https://aliasrobotics.com/case-study-dragos-CTF.php) |
...
| [![](assets/004-case-study-hackerone-e4227cc033.png)](https://aliasrobotics.com/case-study-hackerone.php) | [![](assets/005-case-study-portada-ecoforest-1c21890bba.png)](https://aliasrobotics.com/case-study-ecoforest.php) |
...
| [![](assets/006-case-study-portada-mir-cai-b5ea1fbf27.png)](https://aliasrobotics.com/case-study-cai-mir.php) | [![](assets/007-case-study-portada-mercado-libre-baf4111573.png)](https://aliasrobotics.com/case-study-mercado-libre.php) |
...
| [![](assets/008-case-study-portada-mqtt-broker-cai-324bc5cb19.png)](https://aliasrobotics.com/case-study-cai-mqtt-broker.php) | [![](assets/009-portada-portswigger-web-1-9ed26a599f.jpg)](https://aliasrobotics.com/case-study-portswigger-1.php) |
...
|---|---|---|---|
| [<img src="assets/034-paper-cai-529eeffabf.png" width="350">](https://arxiv.org/pdf/2504.06017) | [<img src="assets/035-cai-automation-vs-autonomy-802c8dc9dc.png" width="350">](https://www.arxiv.org/pdf/2506.23592) | [<img src="assets/036-cai-fluency-cover-d2dd0655af.png" width="350">](https://arxiv.org/pdf/2508.13588) | [<img src="assets/037-aihackers-744fa337cc.jpeg" width="350">](https://arxiv.org/pdf/2508.21669) |
...
|---|---|---|---|
|  [<img src="assets/038-humanoids-cover-78f010b186.png" width="350">](https://arxiv.org/pdf/2509.14139) | [<img src="assets/039-humanoid-b354eef43a.png" width="350">](https://arxiv.org/pdf/2509.14096) | [<img src="assets/040-cai-ad-3188dbef15.png" width="350">](https://arxiv.org/pdf/2510.17521) | [<img src="assets/041-caibench-banner2-5caa5bad77.png" width="350">](https://arxiv.org/pdf/2510.24317) |
...
|-----------------------------------------------|---------------------------------|
| [![asciicast](assets/010-asciicast-023b78dd2e.svg)](https://asciinema.org/a/dNv705hZel2Rzrw0cju9HBGPh) | [![asciicast](assets/011-asciicast-63cb65ef98.svg)](https://asciinema.org/a/9Hc9z1uFcdNjqP3bY5y7wO1Ww) |

| CAI on JWT@PortSwigger CTF — Cybersecurity AI | CAI on HackableII Boot2Root CTF — Cybersecurity AI |
|-----------------------------------------------|---------------------------------|
| [![asciicast](assets/012-asciicast-dedf330de2.svg)](https://asciinema.org/a/713487) | [![asciicast](assets/013-asciicast-b1886bb2a9.svg)](https://asciinema.org/a/713485) |
...
<div align="center">
  <p>
    <a align="center" href="" target="https://github.com/aliasrobotics/CAI">
      <img
        width="100%"
        src="assets/042-caiedu-83b700881e.png"
      >
    </a>
  </p>
</div>
...
|-------|----------------|---------|---------|
| **Episode 0**: What is CAI? | Cybersecurity AI (`CAI`) explained  |  [![Watch the video](assets/014-watch-the-video-36f8e8c15f.jpg)](https://www.youtube.com/watch?v=nBdTxbKM4oo) | [![Watch the video](assets/015-watch-the-video-13350c9154.jpg)](https://www.youtube.com/watch?v=FaUL9HXrQ5k) |
| **Episode 1**: The `CAI` Framework | Vision & Ethics - Explore the core motivation behind CAI and delve into the crucial ethical principles guiding its development. Understand the motivation behind CAI and how you can actively contribute to the future of cybersecurity and the CAI framework. | [![Watch the video](assets/016-watch-the-video-3f567e498b.jpg)](https://www.youtube.com/watch?v=QEiGdsMf29M&list=PLLc16OUiZWd4RuFdN5_Wx9xwjCVVbopzr&index=3) |  |
| **Episode 2**: From Zero to Cyber Hero | Breaking into Cybersecurity with AI - A comprehensive guide for complete beginners to become cybersecurity practitioners using CAI and AI tools. Learn how to leverage artificial intelligence to accelerate your cybersecurity learning journey, from understanding basic security concepts to performing real-world security assessments, all without requiring prior cybersecurity experience. | [![Watch the video](assets/017-watch-the-video-285386133e.jpg)](https://www.youtube.com/watch?v=hSTLHOOcQoY&list=PLLc16OUiZWd4RuFdN5_Wx9xwjCVVbopzr&index=14) |  |
| **Episode 3**: Vibe-Hacking Tutorial | "My first Hack" - A Vibe-Hacking guide for newbies. We demonstrate a simple web security hack using a default agent and show how to leverage tools and interpret CAI output with the help of the CAI Python API. You'll also learn to compare different LLM models to find the best fit for your hacking endeavors. | [![Watch the video](assets/018-watch-the-video-93fe51f49d.jpg)](https://www.youtube.com/watch?v=9vZ_Iyex7uI&list=PLLc16OUiZWd4RuFdN5_Wx9xwjCVVbopzr&index=1) | [![Watch the video](assets/019-watch-the-video-e3083ec214.jpg)](https://www.youtube.com/watch?v=iAOMaI1ftiA&list=PLLc16OUiZWd4RuFdN5_Wx9xwjCVVbopzr&index=2) |
| **Episode 4**: Intro ReAct | The Evolution of LLMs - Learn how LLMs evolved from basic language models to advanced multiagency AI systems. From basic LLMs to Chain-of-Thought and Reasoning LLMs towards ReAct and Multi-Agent Architectures. Get to know the basic terms | [![Watch the video](assets/020-watch-the-video-6dbb4c635c.jpg)](https://www.youtube.com/watch?v=tLdFO1flj_o&list=PLLc16OUiZWd4RuFdN5_Wx9xwjCVVbopzr&index=13) | |
| **Episode 5**: CAI on CTF challenges | Dive into Capture The Flag (CTF) competitions using CAI. Learn how to leverage AI agents to solve various cybersecurity challenges including web exploitation, cryptography, reverse engineering, and forensics. Discover how to configure CAI for competitive hacking scenarios and maximize your CTF performance with intelligent automation. | [![Watch the video](assets/021-watch-the-video-7f3a5d1404.jpg)](https://www.youtube.com/watch?v=MrXTQ0e2to4&list=PLLc16OUiZWd4RuFdN5_Wx9xwjCVVbopzr&index=13) | [![Watch the video](assets/022-watch-the-video-f690093207.jpg)](https://www.youtube.com/watch?v=r9US_JZa9_c&list=PLLc16OUiZWd4RuFdN5_Wx9xwjCVVbopzr&index=12) |
|  |  |  |  |
| **Annex 1**: `CAI` 0.5.x release  | Introduce version 0.5 of `CAI` including new multi-agent functionality, new commands such as `/history`, `/compact`, `/graph` or `/memory` and a case study showing how `CAI` found a critical security flaw in OT heap pumps spread around the world. |  [![Watch the video](assets/023-watch-the-video-c57db1bdb7.jpg)](https://www.youtube.com/watch?v=OPFH0ANUMMw) | [![Watch the video](assets/024-watch-the-video-0018193323.jpg)](https://www.youtube.com/watch?v=Q8AI4E4gH8k) |
| **Annex 2**: `CAI` 0.4.x release and `alias0`  | Introducing version 0.4 of `CAI` with *streaming* and improved MCP support. We also introduce `alias0`, the Privacy-First Cybersecurity AI, a Model-of-Models Intelligence that implements a Privacy-by-Design architecture and obtains state-of-the-art results in cybersecurity benchmarks. |  [![Watch the video](assets/025-watch-the-video-325eb726d1.jpg)](https://www.youtube.com/watch?v=NZjzfnvAZcc) |  |
| **Annex 3**: Cybersecurity AI Community Meeting #1  | First Cybersecurity AI (`CAI`) community meeting, over 40 participants from academia, industry, and defense gathered to discuss the open-source scaffolding behind CAI — a project designed to build agentic AI systems for cybersecurity that are open, modular, and Bug Bounty-ready. |  [![Watch the video](assets/026-watch-the-video-0e1b3969fb.jpg)](https://www.youtube.com/watch?v=4JqaTiVlgsw) |  |
| **Annex 4**: `CAI PRO` PoC  | Short proof-of-concept demonstration of [CAI PRO](https://aliasrobotics.com/cybersecurityai.php) capabilities showcasing the Professional Edition with unlimited `alias1` tokens, unrestricted AI, and enterprise-grade security testing features. | ![CAI PRO Demo](assets/027-cai-pro-demo-f2d5d401c3.gif) |  |
| **Annex 5**: `CAI` PoC  | Short proof-of-concept demonstration of CAI Community Edition showcasing the open-source framework's core capabilities for AI-powered security testing and vulnerability discovery. | ![CAI Demo](assets/028-cai-demo-afec4c04e5.gif) |  |
| **Annex 6**: CAI in `Jaula del N00B`  |  CAI (CIBERSEGURIDAD CON IA) LUIJAIT EN LA JAULA DEL N00B  - Demonstration and discussion of CAI framework capabilities in the popular Spanish cybersecurity podcast/show. |  | [![Watch the video](assets/029-watch-the-video-537fae52f9.jpg)](https://www.youtube.com/watch?v=KD2_xzIOkWg) |
...
![](assets/030-tracing-df73dff519.png)
...
![CAI Development Environment](assets/031-cai-development-environment-45e03ded8c.gif)
