...
![Image 4: Diagram titled “Layered domain architecture with explicit cross-cutting boundaries.” Inside the business logic domain are modules: Types → Config → Repo, and Providers → Service → Runtime → UI, with App Wiring + UI at the bottom. A Utils module sits outside the boundary and feeds into Providers.](assets/004-image-4-diagram-titled-layered-domain-architecture-with-explicit-cross-cutting-b-a3d96c4cd8.png)
...
![Image 5: Equip responses API > card image](assets/005-image-5-equip-responses-api-card-image-a86d18ccc1.png)
...
![Image 6: fin eng (credits) > card image](assets/006-image-6-fin-eng-credits-card-image-e9473e6c66.png)

[Beyond rate limits: scaling access to Codex and Sora Engineering Feb 13, 2026](http://openai.com/index/beyond-rate-limits/)

![Image 7: Codex harness > card image](assets/007-image-7-codex-harness-card-image-d9ef5bbf8b.png)

[Unlocking the Codex harness: how we built the App Server Engineering Feb 4, 2026](http://openai.com/index/unlocking-the-codex-harness/)
