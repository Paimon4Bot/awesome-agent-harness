...
[View all](http://openai.com/news/engineering/)

![Image 6: Equip responses API > card image](assets/006-image-6-equip-responses-api-card-image-a86d18ccc1.png)

[From model to agent: Equipping the Responses API with a computer environment Engineering Mar 11, 2026](http://openai.com/index/equip-responses-api-computer-environment/)

![Image 7: fin eng (credits) > card image](assets/007-image-7-fin-eng-credits-card-image-e9473e6c66.png)

[Beyond rate limits: scaling access to Codex and Sora Engineering Feb 13, 2026](http://openai.com/index/beyond-rate-limits/)

![Image 8: harness eng > card image](assets/008-image-8-harness-eng-card-image-4b8dcab84a.png)

[Harness engineering: leveraging Codex in an agent-first world Engineering Feb 11, 2026](http://openai.com/index/harness-engineering/)
...
*   [OpenAI for Science](http://openai.com/science/)
...
Sora
*   [Sora Overview](http://openai.com/sora/)
*   [Features](http://openai.com/sora/#features)
*   [Pricing](http://openai.com/sora/#pricing)
