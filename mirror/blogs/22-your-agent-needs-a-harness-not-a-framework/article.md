...
![Image 2: Utah harness architecture](assets/001-image-2-utah-harness-architecture-e4e9100b8d.png)
...
For a step-by-step walkthrough of this pattern, see the [agent tool loop guide](http://www.inngest.com/docs/ai-patterns/agent-tool-loops?ref=blog-your-agent-needs-a-harness-not-a-framework).
...
![Image 3: Utah harness functions](assets/002-image-3-utah-harness-functions-807ee662e3.png)
...
There are a lot of fun UX things we'd like to add built on the Inngest API and our Insights feature to build session monitoring for coding sessions. We will also explore using `step.waitForEvent()` to create [human-in-the-loop approval flows](http://www.inngest.com/docs/ai-patterns/human-in-the-loop?ref=blog-your-agent-needs-a-harness-not-a-framework) when more input is needed.
...
[Contact us](http://www.inngest.com/contact?ref=blog-your-agent-needs-a-harness-not-a-framework)

## In the middle of chaos

Develop reliable AI products, every time

[Let's Talk](http://www.inngest.com/contact?ref=-blog-your-agent-needs-a-harness-not-a-framework-footer-cta)

[I'd rather look at the docs first](http://www.inngest.com/docs?ref=-blog-your-agent-needs-a-harness-not-a-framework-footer-cta)

### Platform

*   [AI & Agents](http://www.inngest.com/ai?ref=footer-links)
*   [Durable Workflows](http://www.inngest.com/uses/durable-workflows?ref=footer-links)
*   [Durable Endpoints](http://www.inngest.com/durable-endpoints?ref=footer-links)
*   [Platform](http://www.inngest.com/platform?ref=footer-links)
*   [Queueing](http://www.inngest.com/compare-to-legacy-queues?ref=footer-links)
*   [Workflow Engines](http://www.inngest.com/uses/workflow-engine?ref=footer-links)
*   [Background Jobs](http://www.inngest.com/uses/serverless-node-background-jobs?ref=footer-links)
*   [Scheduled and cron jobs](http://www.inngest.com/uses/serverless-cron-jobs?ref=homepage-footer-links)

### Explore

*   [Docs](http://www.inngest.com/docs?ref=footer-links)
*   [Inngest vs. Traditional Queues](http://www.inngest.com/compare-to-legacy-queues?ref=footer-links)
*   [Inngest vs. Kafka](http://www.inngest.com/blog/simplifying-queues-modern-kafka-alternative?ref=footer-links)
*   [Inngest vs. Temporal](http://www.inngest.com/compare-to-temporal?ref=footer-links)
*   [Solving for Next.js Timeouts](http://www.inngest.com/blog/how-to-solve-nextjs-timeouts?ref=footer-links)

### Company

*   [Blog](http://www.inngest.com/blog?ref=footer-links)
*   [Changelog](http://www.inngest.com/changelog?ref=footer-links)
*   [Roadmap](https://roadmap.inngest.com/roadmap?ref=footer-links)
*   [About](http://www.inngest.com/about?ref=footer-links)
*   [Careers](http://www.inngest.com/careers?ref=footer-links)
...
[Fetching status...](https://status.inngest.com/ "Status updated at ")

© 2026 Inngest Inc. All rights reserved.

[Privacy Policy](http://www.inngest.com/privacy?ref=footer-links)

|

[Terms](http://www.inngest.com/terms?ref=footer-links)

|

[Security](http://www.inngest.com/security?ref=footer-links)
