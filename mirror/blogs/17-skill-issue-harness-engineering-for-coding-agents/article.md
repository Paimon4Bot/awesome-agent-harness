...
![Image 2: harness components](assets/001-image-2-harness-components-f3b61cd89c.png)_Image from [Viv's post](https://blog.langchain.com/the-anatomy-of-an-agent-harness/)_
...
![Image 4: working backwards from what models can't do natively](assets/003-image-4-working-backwards-from-what-models-can-t-do-natively-b5eeafdeb9.png)_Image from [Viv's post](https://blog.langchain.com/the-anatomy-of-an-agent-harness/)_
