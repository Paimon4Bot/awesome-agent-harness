...
Products
    *   [Claude](http://claude.com/product/overview)
    *   [Claude Code](http://claude.com/product/claude-code)
    *   [Claude Cowork](http://claude.com/product/cowork)

Features

    *   [Claude for Chrome](http://claude.com/claude-for-chrome)
    *   [Claude for Slack](http://claude.com/claude-for-slack)
    *   [Claude for Excel](http://claude.com/claude-for-excel)
    *   [Claude for PowerPoint](http://claude.com/claude-for-powerpoint)
    *   [Skills](http://claude.com/skills)
...
Platform
    ...
    *   [Overview](http://claude.com/platform/api)
...
Use cases
    *   [AI agents](http://claude.com/solutions/agents)
    *   [Claude Code Security](http://claude.com/solutions/claude-code-security)
    *   [Coding](http://claude.com/solutions/coding)

Industries

    *   [Customer support](http://claude.com/solutions/customer-support)
    *   [Education](http://claude.com/solutions/education)
    *   [Financial services](http://claude.com/solutions/financial-services)
    *   [Government](http://claude.com/solutions/government)
    *   [Healthcare](http://claude.com/solutions/healthcare)
    *   [Life sciences](http://claude.com/solutions/life-sciences)
    *   [Nonprofits](http://claude.com/solutions/nonprofits)

*
Pricing

    *   [Overview](http://claude.com/pricing)
    *   [API](http://claude.com/pricing#api)

Plans

    *   [Pro](http://claude.com/pricing/pro)
    *   [Max](http://claude.com/pricing/max)
    *   [Team](http://claude.com/pricing/team)
    *   [Enterprise](http://claude.com/pricing/enterprise)

*
Resources

Insights
    *   [Blog](http://claude.com/blog)
    *   [Customer stories](http://claude.com/customers)
    *   [Anthropic news](https://www.anthropic.com/news)

Learn

    *   [Anthropic Academy](https://www.anthropic.com/learn)
    *   [Courses](http://claude.com/resources/courses)
    *   [Tutorials](http://claude.com/resources/tutorials)
    *   [Use cases](http://claude.com/resources/use-cases)

Tools

    *   [Connectors](http://claude.com/connectors)
    *   [Plugins](http://claude.com/plugins)

Connect

    *   [Events](https://www.anthropic.com/events)
    *   [Community](http://claude.com/community)

*   [Login](https://claude.ai/login)

*    Contact sales [Contact sales](http://claude.com/contact-sales)Contact sales
...
1.   Blog [Blog](http://claude.com/blog) /
2.   Building agents with the Claude Agent SDK

Explore here

*   [Ask questions about this page](http://claude.com/blog/building-agents-with-the-claude-agent-sdk#)
*   [Copy as markdown](http://claude.com/blog/building-agents-with-the-claude-agent-sdk#)
...
*     Category [Claude Code](https://claude.com/blog/category/claude-code) [Agents](https://claude.com/blog/category/agents)
*     Product Claude Code  Claude Platform
*     Date September 29, 2025
*     Reading time 5 min
*     Share [Copy link](http://claude.com/blog/building-agents-with-the-claude-agent-sdk#)https://claude.com/blog/building-agents-with-the-claude-agent-sdk
...
[Harnessing Claude’s intelligence](http://claude.com/blog/building-agents-with-the-claude-agent-sdk#)Harnessing Claude’s intelligence
...
[Product management on the AI exponential](http://claude.com/blog/building-agents-with-the-claude-agent-sdk#)Product management on the AI exponential
...
[How AI helps break the cost barrier to COBOL modernization](http://claude.com/blog/building-agents-with-the-claude-agent-sdk#)How AI helps break the cost barrier to COBOL modernization
...
[Bringing automated preview, review, and merge to Claude Code on desktop](http://claude.com/blog/building-agents-with-the-claude-agent-sdk#)Bringing automated preview, review, and merge to Claude Code on desktop
...
*   Claude [Claude](http://claude.com/product/overview)Claude
*   Claude Code [Claude Code](http://claude.com/product/claude-code)Claude Code
*   Claude Code for Enterprise [Claude Code for Enterprise](http://claude.com/product/claude-code/enterprise)Claude Code for Enterprise
*   Claude Cowork [Claude Cowork](http://claude.com/product/cowork)Claude Cowork
*   Pro plan [Pro plan](http://claude.com/pricing/pro)Pro plan
*   Max plan [Max plan](http://claude.com/pricing/max)Max plan
*   Team plan [Team plan](http://claude.com/pricing/team)Team plan
*   Enterprise plan [Enterprise plan](http://claude.com/pricing/enterprise)Enterprise plan
*   Download app [Download app](http://claude.com/download)Download app
*   Pricing [Pricing](http://claude.com/pricing)Pricing
*   Log in [Log in](https://claude.ai/login)Log in

Features

*   Claude for Chrome [Claude for Chrome](http://claude.com/claude-for-chrome)Claude for Chrome
*   Claude for Slack [Claude for Slack](http://claude.com/claude-for-slack)Claude for Slack
*   Claude for Excel [Claude for Excel](http://claude.com/claude-for-excel)Claude for Excel
*   Claude for PowerPoint [Claude for PowerPoint](http://claude.com/claude-for-powerpoint)Claude for PowerPoint
*   Skills [Skills](http://claude.com/skills)Skills
...
*   AI agents [AI agents](http://claude.com/solutions/agents)AI agents
*   Claude Code Security [Claude Code Security](http://claude.com/solutions/claude-code-security)Claude Code Security
*   Code modernization [Code modernization](http://claude.com/solutions/code-modernization)Code modernization
*   Coding [Coding](http://claude.com/solutions/coding)Coding
*   Customer support [Customer support](http://claude.com/solutions/customer-support)Customer support
*   Education [Education](http://claude.com/solutions/education)Education
*   Financial services [Financial services](http://claude.com/solutions/financial-services)Financial services
*   Government [Government](http://claude.com/solutions/government)Government
*   Healthcare [Healthcare](http://claude.com/solutions/healthcare)Healthcare
*   Life sciences [Life sciences](http://claude.com/solutions/life-sciences)Life sciences
*   Nonprofits [Nonprofits](http://claude.com/solutions/nonprofits)Nonprofits

Claude Platform

*   Overview [Overview](http://claude.com/platform/api)Overview
...
*   Marketplace [Marketplace](http://claude.com/platform/marketplace)Marketplace
*   Amazon Bedrock [Amazon Bedrock](http://claude.com/partners/amazon-bedrock)Amazon Bedrock
*   Google Cloud’s Vertex AI [Google Cloud’s Vertex AI](http://claude.com/partners/google-cloud-vertex-ai)Google Cloud’s Vertex AI
*   Microsoft Foundry [Microsoft Foundry](http://claude.com/partners/microsoft-foundry)Microsoft Foundry
*   Regional compliance [Regional compliance](http://claude.com/regional-compliance)Regional compliance
*   Console login [Console login](https://platform.claude.com/)Console login

Resources

*   Blog [Blog](http://claude.com/blog)Blog
*   Claude partner network [Claude partner network](http://claude.com/partners)Claude partner network
*   Community [Community](http://claude.com/community)Community
*   Connectors [Connectors](http://claude.com/connectors)Connectors
*   Courses [Courses](https://www.anthropic.com/learn)Courses
*   Customer stories [Customer stories](http://claude.com/customers)Customer stories
...
*   Plugins [Plugins](http://claude.com/plugins)Plugins
*   Powered by Claude [Powered by Claude](http://claude.com/partners/powered-by-claude)Powered by Claude
*   Service partners [Service partners](http://claude.com/partners/services)Service partners
*   Startups program [Startups program](http://claude.com/programs/startups)Startups program
*   Tutorials [Tutorials](http://claude.com/resources/tutorials)Tutorials
*   Use cases [Use cases](http://claude.com/resources/use-cases)Use cases

Company

*   Anthropic [Anthropic](https://www.anthropic.com/)Anthropic
*   Careers [Careers](https://www.anthropic.com/careers)Careers
*   Economic Futures [Economic Futures](https://www.anthropic.com/economic-futures)Economic Futures
*   Research [Research](https://www.anthropic.com/research)Research
*   News [News](https://www.anthropic.com/news)News
...
*   Privacy policy [Privacy policy](https://www.anthropic.com/legal/privacy)Privacy policy
...
[English (US)](http://claude.com/blog/building-agents-with-the-claude-agent-sdk)

[日本語 (Japan)](http://claude.com/ja-jp)

[Deutsch (Germany)](http://claude.com/de-de)

[Français (France)](http://claude.com/fr-fr)

[한국어 (South Korea)](http://claude.com/ko-kr)
